...
const Skills = () => {
  return (
    <Container className="icons my-5" id="skills">
      ...
      <Row xl={12} lg={12} md={12} sm={12} className="container-icons">
        <div  className="my-3 icons">
          <div xl={3} lg={3} md={3} sm={3} className="mx-5 d-flex flex-row justify-content-center align-items-center">
            <IoLogoJavascript className="js-icon mx-2 icon" />
            <span>JavaScript</span>
          </div>

          <div xl={3} lg={3} md={3} sm={3} className=" mx-5 d-flex flex-row justify-content-center align-items-center">
            <SiNextdotjs className="next-icon mx-2 icon" />
            <span>NextJS</span>
          </div>
          <div xl={3} lg={3} md={3} sm={3} className="mx-2 d-flex flex-row justify-content-center align-items-center">
            <SiTailwindcss className="tailwind-icon mx-2 icon" />
            <span>TailwindCSS</span>
          </div>
        </div>
        <div xl={12} lg={12} md={12} sm={12} className="my-5 icons">
          <div xl={3} lg={3} md={3} sm={3} className="mx-5 d-flex flex-row justify-content-center align-items-center">
            <FaReact className="react-icon mx-2 icon" />
            <span>ReactJS</span>
          </div>
          <div xl={3} lg={3} md={3} sm={3} className="mx-5 d-flex flex-row justify-content-center align-items-center">
            <IoLogoCss3 className="css-icon mx-2 icon" />
            <span>CSS</span>
          </div>
          <div xl={3} lg={3} md={3} sm={3} className=" d-flex flex-row justify-content-center align-items-center">
            <SiTypescript className="ts-icon mx-2 icon" />
